...
```
9. But the firmware is updated from time to time, you can also set a “firmware update” service, move it to /etc/systemd/system, and set a “firmware.timer” based on this service,Please replace yourname in the script with your personal user name
